...
by 27.9\% to 44.3\% against the Webster plan and by 27.9\% to 96.1\% against the equal-split plan, with
...
delay against both baselines in all fifteen cells, by 27.9\% to 44.3\% against the Webster plan and by
...
baselines in 71 of 72 cells, spanning 547 to 2462~veh/h, and never falls below $+26.1\%$ against the
...
every cell of both the primary grid and a wider 72-cell robustness grid but one, by 27.9\% to 44.3\% at a
