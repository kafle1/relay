...
|---|---|---|---|
| **Detection model** | **YOLO11s** (fine-tuned) | YOLO26s / YOLO26n | YOLO11 has the deepest fine-tuning ecosystem under time pressure; YOLO26 is faster on CPU + has small-object STAL but is only ~6mo old with thin community coverage. Benchmark both on your footage. |
...
- **Avoid:** flow-project/flow (Py3.7/TF1.15, stale); darkflow; sub-10-star no-license throwaway repos.
